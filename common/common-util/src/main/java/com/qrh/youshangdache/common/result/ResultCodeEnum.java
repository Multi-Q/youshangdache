...
public enum ResultCodeEnum {
    ...
    ORDER_SNAP_UP_FAILED(220, "抢单失败"),
    MAP_SERVICE_CALL_FAILED(221, "地图服务调用失败"),
    PROFITSHARING_FAIL(222, "分账调用失败"),
    DRIVER_NOT_START_SERVICE(223, "司机未开启代驾服务，不能更新位置信息"),
    DRIVER_START_LOCATION_DISTANCE_ERROR(224, "距离代驾起始点1公里以内才能确认"),
    DRIVER_END_LOCATION_DISTANCE_ERROR(225, "距离代驾终点2公里以内才能确认"),
    IMAGE_AUDITION_FAIL(226, "图片审核不通过"),
    FILE_UPLOAD_FAILED(227,"上传失败"),
    DRIVER_NOT_AUTH(228, "认证通过后才可以开启代驾服务"),
    DRIVER_NOT_FACIAL_RECOGNITION(229, "当日未进行人脸识别"),

    COUPON_EXPIRED(230, "优惠券已过期"),
